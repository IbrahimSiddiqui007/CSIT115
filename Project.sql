...
select * from Disease;
select * from Legal_Req;
select * from Pets;
select * from Customer;
select * from Appointment;
select * from MedInformation;
...
select distinct mi.CName,mi.PName, if(p.PName=mi.PName and p.CName=mi.CName,MSFName,NULL) as medicine from MedInformation as mi, Pets as p;
...
-- Task 5: For a customer, you can show all records related to his/her pet --
select distinct c.CName,p.PName,p.CTPrimary,p.LWeight,p.Spcs,mi.MSFName,vp.VName,vp.VDate from Customer as C,Pets as p,MedInformation as mi,VacPet as vp where c.CName=p.CName and p.CName=mi.CName and p.PName=vp.PName;
